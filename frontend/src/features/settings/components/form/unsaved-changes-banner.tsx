      ...
      <AnimatePresence>
        {isDirty && (
          <m.div
            ...
            role="status"
            className="pointer-events-auto flex flex-col gap-3 rounded-2xl border border-line bg-surface/95 px-4 py-3 shadow-elevated backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between"
          >
